      ...
      <main className="flex-1 pt-20">
        ...
        <section className="py-8">
          <div className="container">
            <div className="flex flex-wrap justify-center gap-3 mb-8 animate-fade-in">
              {["all", "exterior", "rooms", "amenities"].map((category) => (
                <button
                  ...
                  className={cn(
                    "px-6 py-3 rounded-xl transition-all android-touch font-medium",
            ...
            {/* Gallery Grid - Android Optimized */}
            <div className="mobile-grid">
              {filteredImages.map((image, index) => (
                <div 
                  key={image.id} 
                  className="relative overflow-hidden android-card aspect-[4/3] cursor-pointer group animate-fade-in android-touch"
        ...
        {/* Lightbox - Android Optimized */}
        {selectedImage !== null && (
          <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4 animate-fade-in">
            <button 
              className="absolute top-4 right-4 text-white p-3 rounded-xl hover:bg-white/10 transition-colors android-touch"
            ...
            <button 
              className="absolute left-4 top-1/2 -translate-y-1/2 text-white p-4 rounded-xl hover:bg-white/10 transition-colors android-touch"
            ...
            <button 
              className="absolute right-4 top-1/2 -translate-y-1/2 text-white p-4 rounded-xl hover:bg-white/10 transition-colors android-touch"
