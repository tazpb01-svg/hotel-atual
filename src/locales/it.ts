  ...
  contact: {
    ...
    questions: {
      checkInOut: {
        ...
        answer: "Il check-in è dalle 12:00 in poi, e il check-out è fino alle 12:00. Il check-in anticipato o il check-out posticipato possono essere organizzati in base alla disponibilità."
      },
      parking: {
